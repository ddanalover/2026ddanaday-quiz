  ...
  const masterExplainDB = [
    {
      ...
      "why": "〜てあげる는 ‘내가 해 준다’는 느낌이 있어 상대에게 베푸는 뉘앙스가 생깁니다. 그래서 청중에게 공손하게 말하는 상황에서는 어색하게 들릴 수 있습니다. 반대로 친구나 팬에게 반말로 말할 때는 친근한 사이라는 느낌을 주면서 자연스럽게 쓸 수 있습니다.",
      "fix": [
      ...
      "summary": "공손한 진행 멘트에는 お/ご + します가 적합합니다. 〜てあげる는 반말이 될 수 있으니 주의합시다."
    },
    {
      "category": "경어와 톤",
      ...
      "why": "見せてください는 상대가 나에게 무언가를 직접 제시해서 보여주기를 바란다는 뉘앙스가 있습니다. 하지만 무대에서 “다음 문제 보여 주세요”라고 말하는 것은 실제로 무언가를 가져와서 보여 달라는 뜻이 아니라, 다음 화면이나 문제를 띄워 진행해 달라고 요청하는 상황에 가깝습니다. 그래서 見せてください보다는 次の問題、お願いします처럼 진행을 부탁하는 표현이 더 잘 맞습니다.",
      "fix": [
    ...
    },
    {
      ...
      "why": "한국어의 ‘~하는 중이다’라는 표현은 일본어에서는 見ています처럼 현재진행형인 〜ています로 쓰거나, 会議中, 準備中처럼 한자어 명사+中의 형태로 쓰는 것이 자연스럽습니다. 그래서 동사 원형 뒤에 바로 中를 붙이는 말은 어색하게 들리기 쉽습니다.",
      "fix": [
        "いま<ruby>映像<rt>えいぞう</rt></ruby>を<ruby>見<rt>み</rt></ruby>ていますか。<br>→ 지금 영상 보는 중인가요?",
        "ただいま<ruby>練習中<rt>れんしゅうちゅう</rt></ruby>です。<br>→ 지금 연습 중입니다."
      ],
      "stepup": "・ただいま<ruby>準備中<rt>じゅんびちゅう</rt></ruby>です。→ 지금 준비 중입니다.<br>・いま<ruby>何<rt>なに</rt></ruby>を<ruby>見<rt>み</rt></ruby>ていますか。→ 지금 무엇을 보는 중인가요?<br>・<ruby>練習<rt>れんしゅう</rt></ruby>する<ruby>中<rt>なか</rt></ruby>で<ruby>気<rt>き</rt></ruby>づきました。→ 연습하는 과정에서 알게 되었습니다.<br>・<ruby>今<rt>いま</rt></ruby>から<ruby>始<rt>はじ</rt></ruby>めるところです。→ 지금 막 시작하려는 참입니다.",
    ...
    },
    {
      ...
      "why": "全員은 사람 전체를 말할 때 쓰고, 全部는 물건이나 내용 전체를 말할 때 씁니다. 둘 다 한국어로는 ‘모두’처럼 보이지만, 무엇이 모두인지에 따라 단어가 달라집니다.",
      "fix": [
      ...
      "summary": "사람은 全員, 사물은 全部를 씁니다."
    },
    {
      "category": "단어 선택",
      "title": "<ruby>隣<rt>となり</rt></ruby>와 구역 표현",
      "wrong": "옆 쪽도 가운데도 고마워!<br>✖ <ruby>隣<rt>となり</rt></ruby>も<ruby>真<rt>ま</rt></ruby>ん<ruby>中<rt>なか</rt></ruby>もありがとう！<br>〇 サイドもセンターもありがとう！",
      "why": "隣는 '隣の席', '私の隣' 처럼 어떤 대상의 바로 옆을 가리킬 때 쓰는 말입니다. 하지만 콘서트에서 말하는 '옆 쪽'이나 '가운데'는 특정 대상의 옆이 아니라 좌석 구역을 의미합니다. 따라서 隣 대신 右, 左, 後ろ, 真ん中 같이 좌석 구역으로 말하는 것이 더 자연스럽습니다. ",
      "fix": [
      ...
      "summary": "무대에서는 구역 이름으로 부르고, 누군가 바로 옆자리를 말할 때는 隣를 씁니다."
    }
  ];
